...
import com.example.player.video.App
import com.example.player.video.MediaItem
import com.example.player.video.VideoApi
...
//    private val selectedIndex by lazy { intent.extras?.getInt(EXTRA_INDEX, 0) ?: 0 }
    ...
    private val selectedPath by lazy { intent.extras?.getString("path") }
...
//        playlistManager.setParameters([selectedPath], selectedIndex)
